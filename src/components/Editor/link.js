...
class LinkData {
  constructor({ data }) {
    ...
    // urlMetadata('https://google.com').then(async (metadata) => {
  ...
  _createImage(url, captionText) {
    ...
    const data = fetch(`https://urlinfo.herokuapp.com/urlInfo/id?url=${url}`)
      ...
      .then(data => {
        ...
        this.details.appendChild(this.leftDetails);
        this.details.appendChild(this.rightDetails);
        // const data = fetch(`https://localhost:5000/urlInfo/id?url=${url}`).then((res) => res.json()).then(data => console.log(data))
    ...
    // const embedUrl = "https://www.msn.com/en-in/money/technology/bill-gates-says-elon-musk-could-make-twitter-worse-but-that-people-should-never-underestimate-him/ar-AAWVi40?ocid=msedgntp";
    // const title = "Bill Gates says Elon Musk could make Twitter 'worse' — but that people should never underestimate him";
    // const description = "Bill Gates expressed concern over how Elon Musk would address misinformation on the social media platform.";
    // const source = "www.msn.com";
    // const imgsrc = "https://img-s-msn-com.akamaized.net/tenant/amp/entityid/AAWVpv8.img?h=315&w=600&m=6&q=60&o=t&l=f&f=jpg&x=465&y=234";
